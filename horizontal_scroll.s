...
HorizText:
	...
	dc.b	'    '
	dc.b	'DURING ALL THAT TIME, I WAS SPENDING SO MUCH '
	dc.b	'TIME WITH CODE AT WORK THAT I DID NOT HAVE '
	dc.b	'THE ENERGY TO CODE ON MY OWN PROJECTS. '
	dc.b	'RECENTLY, THOUGH, MY JOB HAS BEEN SHIFTING '
	dc.b	'IN A DIFFERENT DIRECTION, AND I AM ENJOYING '
	dC.b	'SPENDING TIME AT THE KEYBOARD ON MY OWN CODE. '
	dc.b	'         '
	dc.b	'I\'D LIKE TO THANK AD FOR THE GREAT MUSIC '
	dc.b	'THAT WAS MADE TO FIT THIS DEMO VERY WELL. '
	dc.b	'I ALSO THANK PANDAFOX A LOT FOR REMAINING A '
	dc.b	'GOOD FRIEND EVEN AFTER I CANCELED TWO DIFFERENT '
	dc.b	'DEMO PROJECTS UNDER HIS FEET. '
	dc.b	'         '
