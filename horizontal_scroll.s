...
HorizText:
	...
	dc.b	'         '
	dc.b	'I AM WRITING A DEMO SCROLLTEXT FOR THE '
	dc.b	'FIRST TIME IN 30 YEARS. I\'S GOOD TO BE BACK. '
	dc.b	'    '
	dc.b	'FOR THIS DEMO, AD COMPOSED THE SUPERB MUSIC '
	dc.b	'THAT HE GOT TO FIT THIS DEMO VERY WELL. '
	dc.b	'PANDAFOX DID A GREAT JOB WITH ALL THE GRAPHICS '
	dc.b	'IN SPITE OF THE ANNOYINGLY SPECIFIC CONSTRAINTS '
	dc.b	'I FORCED ON HIM. '
	dc.b	'            '
	dc.b	'IN THE BIGGER PICTURE, I (DJAYBEE) WOULD LIKE TO THANK ALL '
	dc.b	'OF THE MEGABUSTERS FOR INTRODUCING ME TO LARGE-SCALE '
	dc.b	'CODING PROJECTS IN A WAY THAT STAYED WITH ME. '
	dc.b	'PRINST AND TRONIC DESERVE SPECIFIC THANKS FOR GUIDING '
	dc.b	'MY FIRST STEPS IN ASSEMBLY. FRIENDLY MENTIONS GO TO '
	dc.b	'GRIZZO, THE SHADOW, YAHOO, WASP, MOBY DICK, BINOUIT, '
	dc.b	'OXWALD, JAILE, BART OF NOISE, AND EVERST. '
	dc.b	'ANNE AND ALINE ALSO CONTRIBUTED TO THE SUCCESS OF '
	dc.b	'THE MEGABUSTERS. LAST BUT NOT LEAST, '
	dc.b	'HUGE THANKS TO PANDAFOX FOR BEING '
